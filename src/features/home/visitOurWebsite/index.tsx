export function VisitOurWebsite() {
  return (
    <>
      <div className=" text-white-paper flex flex-col md:flex-row md:justify-between justify-center items-center p-5 m-5 my-16 bg-no-repeat bg-cover bg-center  bg-[url('/assets/img/background-visit-website.png')] bg-[#525151]">
        <div>
